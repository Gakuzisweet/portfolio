...
export function ProjectCard({
  ...
  return (
    <button
      ...
      className="group flex min-h-[280px] flex-col justify-between rounded-xl border border-border bg-bg-raised p-6 text-left transition-colors hover:border-accent/50 focus-visible:border-accent/50"
    >
      <div>
