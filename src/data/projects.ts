...
export const projects: Project[] = [
  {
    ...
    results: [
      ...
      "Synthesized and run on physical Zybo Z7-10 hardware — UART output observed on a PC terminal through an external FTDI USB-to-serial adapter wired to a Pmod pin.",
